...
namespace FronkonGames.SpiceUp.Slash
{
  ...
  public sealed partial class Slash
  {
    ...
    private static readonly Slash[] NoEffects = new Slash[0];
    ...
    public static Slash Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is Slash)
              return scriptableRendererData.rendererFeatures[i] as Slash;
          }
        }
