...
namespace MoreMountains.InfiniteRunnerEngine
{
	...
	public class PlayableCharacter : MonoBehaviour
	{
        ...
        [Tooltip("The Invincibility Shield object for first few invincible seconds")]
        ...
        protected bool _invLayerActive;
        /// <summary>
        ...
        protected virtual void Awake()
		{
            ...
            // 1. Make player invincible immediately
            SetLayerRecursively(gameObject, _invincibleLayer);
			_invLayerActive = true;
